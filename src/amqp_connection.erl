...
%% space.
start(AmqpParams) ->
    Module = case AmqpParams of
                 #amqp_params_direct{}  -> amqp_direct_connection;
                 #amqp_params_network{} -> amqp_network_connection
             end,
    ...
    {ok, _Sup, Connection} =
        amqp_sup:start_connection_sup(Module, AmqpParams),
